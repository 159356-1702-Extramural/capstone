...
function buy_monopoly(title, driver, os, browser, version) {
  test(title + ' - ' + os + ' | ' + browser + ' | ' + version + ')', async t => {
    ...
    try {
      driver.manage()
        ...
        .setSize(1024, 768);
      await driver.get(
        'http://capstone-settlers.herokuapp.com/?startWithCards=10&setup=skip&dev_card=monopoly');
      ...
      await driver.findElement(webdriver.By.className('buybutton'))
        .click();
      await driver.findElement(webdriver.By.className('finishturnbutton'))
        .click();
      await driver.findElement(webdriver.By.xpath("//div[@class='popup_inner]"));
      await driver.findElement(webdriver.By.id('useMonopoly'))
        .click();

      // finished the sequence above
      t.truthy(true);
...
function trade4to1(title, driver, os, browser, version) {
  test(title + ' - ' + os + ' | ' + browser + ' | ' + version + ')', async t => {
    var passedBool = true;
    try {
      driver.manage()
        ...
        .setSize(1024, 768);
      await driver.get(
        'http://capstone-settlers.herokuapp.com/?startWithCards=10&setup=skip&fixedDice=true');
      await driver.findElement(webdriver.By.id('play'))
        .click();
      await driver.findElement(webdriver.By.id('txt_player1'))
        .sendKeys(os + "|" + browser + "|" + version);
      ...
      var startGrain = await driver.findElement(webdriver.By.className('graincount'))
        .getText();
      var startBrick = await driver.findElement(webdriver.By.className('brickcount'))
        .getText();

      await driver.findElement(webdriver.By.className('tradebutton'))
        .click();
      await driver.findElement(webdriver.By.xpath('//div[@data-resource="brick" and @class="card_give"]'))
        .click();
      await driver.findElement(webdriver.By.xpath(
          '//div[@data-resource="grain" and @class="card_receive"]'))
        .click();
      await driver.findElement(webdriver.By.className('btn-info'))
        .click();
      ...
      var finishGrain = await driver.findElement(webdriver.By.className('graincount'))
        .getText();
      var finishBrick = await driver.findElement(webdriver.By.className('brickcount'))
        .getText();
...
function buy_year_of_plenty(title, driver, os, browser, version) {
  test(title + ' - ' + os + ' | ' + browser + ' | ' + version + ')', async t => {
    var passedBool = true;
    try {
      driver.manage()
        ...
        .setSize(1024, 768);
      await driver.get(
        'http://capstone-settlers.herokuapp.com/?startWithCards=10&setup=skip&fixedDice=true&dev_card=year_of_plenty'
      );
      await driver.findElement(webdriver.By.id('play'))
        .click();
      await driver.findElement(webdriver.By.id('txt_player1'))
      ...
      //below code twice to pass through two modals
      let button = driver.findElement(webdriver.By.className('btn-info'))
      await driver.wait(webdriver.until.elementIsVisible(button), 300)
        .click();
      let button1 = driver.findElement(webdriver.By.className('btn-info'))
      await driver.wait(webdriver.until.elementIsVisible(button1), 300)
        .click();
      ...
      let year_of_plenty = driver.findElement(webdriver.By.className('year_of_plenty'))
      await driver.wait(webdriver.until.elementIsVisible(year_of_plenty), 300)
        .click();
      if (year_of_plenty) {
        await driver.findElement(webdriver.By.xpath(
            '//div[@data-resource="brick" and @class="year_receive"]'))
          .click();
        await driver.findElement(webdriver.By.xpath(
            '//div[@data-resource="grain" and @class="year_receive"]'))
          .click();
        await driver.findElement(webdriver.By.className('year_of_plenty_button'))
          .click();

        //test that the monopoly button is shown
        t.is(await driver.findElement(webdriver.By.className('graincount'))
          .getText(), ((parseInt(startGrain)) + 1) + "");
        t.is(await driver.findElement(webdriver.By.className('brickcount'))
          .getText(), ((parseInt(startBrick)) + 1) + "");
      }
      saucelabs.updateJob(driver.sessionID, {
        name: title + " | " + os + " | " + browser + " | " + version,
        passed: passedBool,
...
function buy_road_building(title, driver, os, browser, version) {
  test(title + ' - ' + os + ' | ' + browser + ' | ' + version + ')', async t => {
    var passedBool = true;
    try {
      driver.manage()
        ...
        .setSize(1024, 768);
      await driver.get(
        'http://capstone-settlers.herokuapp.com/?startWithCards=10&setup=skip&fixedDice=true&dev_card=road_building'
      );
      await driver.findElement(webdriver.By.id('play'))
        .click();
      await driver.findElement(webdriver.By.id('txt_player1'))
      ...
      //get initial values to test against (they will be different based on resources distributed)
      var startLumber = await driver.findElement(webdriver.By.className('lumbercount'))
        .getText();
      var startBrick = await driver.findElement(webdriver.By.className('brickcount'))
        .getText();
      ...
      //test that the monopoly button is shown
      t.is(await driver.findElement(webdriver.By.className('lumbercount'))
        .getText(), ((parseInt(startLumber)) + 2) + "");
      t.is(await driver.findElement(webdriver.By.className('brickcount'))
        .getText(), ((parseInt(startBrick)) + 2) + "");
...
var testTitles = ['Start up and Setup complete', 'Popups display and close', 'Play Road Building',
  'Purchase Monopoly', 'Trading 4:1', 'Play Year of Plenty'
];
