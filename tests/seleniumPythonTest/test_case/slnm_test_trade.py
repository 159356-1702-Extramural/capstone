...
class SettlerSeleniumTest(unittest.TestCase):
    ...
    def test_trade(self):
        ...
        WebDriverWait(wd,80).until(EC.visibility_of(wd.find_element_by_xpath("//div[@class='popup_inner']//div[.='Begin Round']"))).click()
        time.sleep(2)
        wd.find_element_by_xpath("//div[@class='resources']/div[6]/div").click()
        # wd.implicitly_wait(1)
        time.sleep(2)
        WebDriverWait(wd,80).until(EC.visibility_of(wd.find_element_by_xpath("//div[@class='popup_inner']/div[4]/div[1]/img"))).click()
        # wd.find_element_by_xpath("//div[@class='popup_inner']/div[4]/div[1]/img").click()
        wd.find_element_by_xpath("//div[@class='popup_inner']/div[7]/div[4]/img").click()
        wd.find_element_by_css_selector("div.btn.btn-info").click()
        time.sleep(3)
