...
class TestAdd(unittest.TestCase):
  def test_buy_dev_card(desired_cap):
    print("set driver")
    ...
    if playerID[0].get_attribute("src") == "https://capstone-settlers.herokuapp.com/images/player0.png":
      ...
      place_item(driver, "settlement_purple_open_4", -603, -180)
      ...
      place_item(driver, "settlement_purple_open_3", -540, 110)
      place_item(driver, "road_purple_open_13", -573, 29)
    ...
    if playerID[0].get_attribute("src") == "https://capstone-settlers.herokuapp.com/images/player2.png":
      ...
      # place first round settlement and road
      place_item(driver, "settlement_blue_open_4", -313, -80)
      place_item(driver, "road_blue_open_14", -392, 228)
